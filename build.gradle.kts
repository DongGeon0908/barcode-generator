...
object DependencyVersion {
    ...
    const val GOOGLE_ZXING_VERSION = "3.5.1"
}
...
dependencies {
    ...
    /** zxing */
    implementation("com.google.zxing:core:${DependencyVersion.GOOGLE_ZXING_VERSION}")
    implementation("com.google.zxing:javase:${DependencyVersion.GOOGLE_ZXING_VERSION}")
